...
require('./investor').default(routes);
require('./manager').default(routes);
require('./transfer').default(routes);
require('./fund').default(routes);
require('./asset').default(routes);
require('./fundAsset').default(routes);
require('./order').default(routes);
require('./trade').default(routes);
require('./document').default(routes);
require('./reward').default(routes);
