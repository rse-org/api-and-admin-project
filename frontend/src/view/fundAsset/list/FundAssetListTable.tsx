...
function FundAssetListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    fundAssetSelectors.selectPermissionToEdit,
  );
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.fundAsset.fields.fund',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.fundAsset.fields.asset',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'percentage'}
                label={i18n(
                  'entities.fundAsset.fields.percentage',
                )}
                align="right"
              />
              <TableCellCustom
                ...
                name={'code'}
                label={i18n(
                  'entities.fundAsset.fields.code',
                )}
              />              
...
export default FundAssetListTable;
